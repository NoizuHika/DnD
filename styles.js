...
const styles = StyleSheet.create({
  ...
  modalButtonsEncounter: {
    flexDirection: 'row',
    justifyContent: 'space-around',
    marginTop: 20,
    width: '85%',
  },
  closeButtonItemEncounter: {
