...
const HomeScreen = ({ navigation }) => {
  ...
  <ImageBackground
       ...
       <View style={styles.buttonContainer}>
          <TouchableOpacity  onPress={() => {handleLoginPress(); console.log('Кнопка "Логин" нажата')}}>
                <Text style={styles.buttonText}>Login</Text>
          </TouchableOpacity>
       </View>
       <View style={[styles.buttonContainer, { bottom: 180 }]}>
          <TouchableOpacity  onPress={() => {handleRegistrationPress(); console.log('Кнопка "Регистрация" нажата')}}>
